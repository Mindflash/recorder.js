(function () {
	var Recorder = {
		...
		_setupFlashContainer: function () {
			...
			ct.setAttribute("id", "recorderFlashContainer");
			ct.setAttribute("style", "position:fixed;left: -9999px;top: -9999px;z-index: 9999;display:table;width:100%;height:100%;background-color: transparent;");
			var inner = document.createElement("div");
			inner.setAttribute("style", "text-align: center; display: table-cell; vertical-align: middle;");
			ct.appendChild(inner);
			document.body.appendChild(ct);
			this.options.flashContainer = ct;
		},

		_clearFlash: function () {
			var obj = this.options.flashContainer.getElementsByTagName('object').item(0);
			if (obj) {
		...
		_loadFlash: function () {
			...
			var ct = this.options.flashContainer;
