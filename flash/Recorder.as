...
public class Recorder {
	...
	public function addExternalInterfaceCallbacks(): void {
		...
		ExternalInterface.addCallback("getEncodedData", this.getEncodedData);
	...
	protected function prepareWav(): ByteArray {
		...
		buffer.position = 0;
		wavWriter.numOfChannels = 1; // set the initial properties of the Wave Writer
	...
	protected function playSampleDataHandler(event: SampleDataEvent): void {
		...
		// this will result in a little down pitch shift.
